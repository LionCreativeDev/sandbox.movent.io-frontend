...
function getActiveModules(user: User): string[] {
  ...
  return (
    Object.entries(merged)
      ...
      .map(
        ([modKey]) =>
          MODULE_CATALOG.find((m) => m.key === modKey)?.name ?? modKey,
      )
  );
}
...
export default function UsersPage() {
  ...
  const [activeCompany, setActiveCompany] = useState<number | "all" | null>(
    null,
  );
  ...
  const statusFor = (user: User): string => {
    ...
    const assignment = assignmentsOf(user).find(
      (a) => a.company_id === activeCompany,
    );
  ...
  const handleToggleStatus = async (user: User) => {
    ...
    if (
      typeof activeCompany === "number" &&
      assignments.some((a) => a.company_id === activeCompany)
    ) {
      await applyToggle(
        user,
        activeCompany,
        statusFor(user) === "active" ? "suspended" : "active",
      );
      return;
    }
  ...
  const handleResetPassword = async (user: User) => {
    if (
      !confirm(
        `Reset ${user.name}'s password? A new temporary password will be generated.`,
      )
    )
      return;
    setActionBusy(user.id);
    ...
    <DashboardLayout title="Users & Permissions">
      <div style={{ width: "100%", maxWidth: "none" }}>
        ...
        {atLimit && (
          ...
          >
            You have reached your user limit ({limit} seats). Upgrade your plan
        ...
        {resetInfo && (
          ...
          >
            ...
            <div style={{ fontSize: 12, color: "#3b82f6", marginBottom: 10 }}>
              Share this temporary password with them now — it will not be shown
              again.
            </div>
            <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: 8,
                  border: "1.5px solid #e2e8f0",
                  background: resetCopied ? "#ecfdf5" : "#fff",
                  color: resetCopied ? "#059669" : "#64748b",
                  cursor: "pointer",
                  fontSize: 12,
                  fontWeight: 600,
                }}
                        ...
                        <td style={{ padding: "14px 16px", maxWidth: 220 }}>
                          {modules.length > 0 || canAddUsers(user) ? (
                            ...
                            >
                              ...
                              {canAddUsers(user) && (
                                <span
                                  title="Can create/invite other users"
                                  style={{
                                    fontSize: 11,
                                    padding: "2px 8px",
                                    borderRadius: 20,
                              ...
                              <>
                                ...
                                <button
                                  ...
                                  style={{
                                    ...
                                    padding: "5px 10px",
                                    borderRadius: 6,
                                    border: `1.5px solid ${status === "active" ? "#fecaca" : "#bbf7d0"}`,
                                    background:
        ...
        >
          ...
          >
            ...
            >
              ...
              <button
                onClick={() => setCompanyPickFor(null)}
                style={{
                  background: "none",
                  border: "none",
                  fontSize: 20,
            ...
            <p style={{ fontSize: 12.5, color: "#64748b", margin: "0 0 16px" }}>
              ...
              — their access everywhere else stays exactly as it is.
            </p>
                  ...
                  >
                    ...
                    <button
                      ...
                      style={{
                        ...
                        fontWeight: 600,
                        cursor:
                          actionBusy === companyPickFor.id ? "wait" : "pointer",
                        whiteSpace: "nowrap",
                      }}
                    >
                      {suspended ? (
