...
import { adminComplianceService, ComplianceProjectOverview } from '@/lib/services/adminComplianceService';
import { Badge, PRIORITY_SC, fmtDate } from '@/components/admin/compliance/shared';
...
export default function ProjectOverviewModal({
  ...
  useEffect(() => {
    let cancelled = false;
    setLoading(true);
    adminComplianceService.project.overview(projectId)
        ...
        <div style={{ padding: '16px 20px', overflowY: 'auto', flex: 1 }}>
          {loading ? (
            ...
            <>
              ...
              <button
                onClick={() => router.push(`/admin/compliance/projects/${project.id}`)}
                style={{
