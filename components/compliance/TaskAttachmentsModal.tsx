...
import { userComplianceService, ComplianceProjectTaskAttachment } from "@/lib/services/userComplianceService";
...
export default function TaskAttachmentsModal({
    ...
    useEffect(() => {
        let cancelled = false;
        setLoading(true);
        userComplianceService.project.taskAttachments(projectId)
