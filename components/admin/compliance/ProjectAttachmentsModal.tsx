...
import { adminComplianceService, ComplianceProjectAttachment } from '@/lib/services/adminComplianceService';
...
export default function ProjectAttachmentsModal({
  ...
  useEffect(() => {
    let cancelled = false;
    setLoading(true);
    adminComplianceService.project.attachments(projectId)
