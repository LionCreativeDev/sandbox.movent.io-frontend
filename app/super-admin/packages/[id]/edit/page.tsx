      ...
      <div style={{ maxWidth: 760, padding: '28px 32px' }}>
        ...
        <div style={{ background: '#fff', borderRadius: 14, border: '1px solid #f1f5f9', overflow: 'hidden' }}>
          <div style={{ padding: '20px 28px', borderBottom: '1px solid #f1f5f9', background: '#fafafa' }}>
            <h2 style={{ margin: 0, fontSize: 20, fontWeight: 700, color: '#0f172a' }}>Edit Package</h2>
            <p style={{ margin: '4px 0 0', fontSize: 13, color: '#94a3b8' }}>Update subscription plan details</p>
          </div>
            ...
            <form onSubmit={handleSubmit} style={{ padding: 28 }}>
              ...
              <div style={{ marginBottom: 28 }}>
                ...
                <p style={{ fontSize: 11, color: '#94a3b8', margin: '-8px 0 16px' }}>
                  Every package here is billed monthly. Its Yearly option is generated automatically —
