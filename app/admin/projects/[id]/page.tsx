          ...
          <div style={card}>
            ...
            {project.billing_summary && (
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: 16 }}>
                <div><div style={{ fontSize: 11, color: '#94a3b8', fontWeight: 600, textTransform: 'uppercase' }}>Subtotal</div><div style={{ fontSize: 15, fontWeight: 700, color: '#0f172a', marginTop: 4 }}>{project.billing_summary.total_subtotal.toLocaleString('en-US', { minimumFractionDigits: 2 })}</div></div>
                <div><div style={{ fontSize: 11, color: '#94a3b8', fontWeight: 600, textTransform: 'uppercase' }}>Tax</div><div style={{ fontSize: 15, fontWeight: 700, color: '#0f172a', marginTop: 4 }}>{project.billing_summary.total_tax.toLocaleString('en-US', { minimumFractionDigits: 2 })}</div></div>
