  ...
  return (
    <DashboardLayout title="Sales Dashboard">
      <div>
        ...
        {/* Invoice Summary — this Seller's own invoices only (see
            Api\User\SalesDashboardController::visibleInvoices()); the company
            switcher in the topbar re-fetches this whole dashboard, invoice
            summary included, scoped to whichever company is active. */}
        <div style={{ marginBottom: 24 }}>
