...
export default function AllTasksPage() {
  ...
  // to that project's own Tasks tab with ?new=1, which opens the full create
  // form that lives there (without the param it just showed the task list).
            ...
            {creatableProjects.length === 0 ? (
              ...
              <>
                ...
                <div style={{ display: 'flex', gap: 10 }}>
                  {/* ?new=1 opens that page's Add Task form straight away.
                      Unlike the staff side (which has a dedicated
                      /tasks/create route), the Admin task form lives inline on
                      the project's Tasks tab — so without this the "Create
                      Task" flow dropped you on the task LIST and left you to
                      find "+ Add Task" yourself. */}
                  <button
                    onClick={() => pickedProjectId && router.push(`/admin/projects/${pickedProjectId}/tasks?new=1`)}
