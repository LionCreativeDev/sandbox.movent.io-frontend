...
import { fmtDate, errorMessage, inp } from '@/components/admin/compliance/shared';
...
// page's "Project Chat History" card, just without navigating away. Mirrors
// components/compliance/ChatModal.tsx (staff portal).
export default function ChatModal({
  ...
  useEffect(() => {
    let cancelled = false;
    setLoading(true);
    adminComplianceService.project.chat(projectId)
  ...
  const handleExport = async () => {
    setExporting(true);
    try {
      await adminComplianceService.project.chatExport(projectId, {
